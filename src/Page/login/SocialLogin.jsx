...
const SocialLogin = () => {
    ...
    return (
        <div className="flex gap-5">
            <button onClick={handleGoogleLogin} className="flex jm_btn rounded-md w-full items-center">
                <div className="">
                    <FaGoogle className="text-2xl text-[#E94235]"/> 
                </div>
                <span className="text-center w-full">Google</span>
            </button>
            <button onClick={handleGitHubLogin} className="flex jm_btn rounded-md w-full items-center">
                <div className="">
